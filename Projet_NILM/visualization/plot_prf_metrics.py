...
from pipeline.preprocessing import preprocess_house
...
def main() -> None:
    ...
    for appliance in args.appliances:
        ...
        # Use POWER_ON_THRESHOLD from config — not a hardcoded literal
    ...
    style_axes(ax,
               title=(f"PR/F1 per appliance (train House {train_house_number} -> "
